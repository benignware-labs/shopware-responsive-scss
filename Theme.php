...
namespace Shopware\Themes\ResponsiveSCSS;
...
class Theme extends \Shopware\Components\Theme
{
     ...
     * @var string
     */
    protected $description = 'Shopware Responsive sass port';
     ...
     * @var string
     */
    protected $author = 'Rafael Nowrotek';
